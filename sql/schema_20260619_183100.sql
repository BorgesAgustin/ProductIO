-- /sql/schema_20260619_183100.sql
-- Creación de tablas de Clientes y Productos y carga de datos iniciales
-- Autor: Briant Gauna
...
CREATE TABLE IF NOT EXISTS productos (
    ...
    nombre VARCHAR(255) NOT NULL,
    familia VARCHAR(100) NOT NULL, -- SERVILLETAS, BOLSITAS, TROQUELADOS, PAJITAS, VASOS
    gramaje FLOAT,
    color VARCHAR(50),
    descripcion TEXT,
    ...
    fabrica_id INT NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UNIQUE KEY uq_sku_fabrica (sku, fabrica_id), -- El SKU debe ser único dentro de la misma fábrica
    FOREIGN KEY (fabrica_id) REFERENCES fabricas(id) ON DELETE CASCADE
);
